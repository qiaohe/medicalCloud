module.exports = {
    ...
    order: {
        ...
        findOrdersByStatus: 'select SQL_CALC_FOUND_ROWS m.*, mo.paidAmount as totalPaidAmount, r.nurseName,r.patientName, r.departmentId, r.departmentName,r.patientMobile,r.memberType, r.hospitalId, r.hospitalName, r.doctorId, r.doctorName,r.patientId from MedicalOrder m left join Registration r on m.registrationId = r.id left join MedicalOrder mo on mo.orderNo=m.referenceOrderNo where m.hospitalId= ? ',
